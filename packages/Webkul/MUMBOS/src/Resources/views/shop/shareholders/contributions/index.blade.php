...
>
    ...
    >
        ...
        <main
            class="flex-1 ml-64 p-6 overflow-auto"
            style="max-height: calc(100vh - 64px - 48px);"
        >
            ...
            @endif
             <div class="mt-8 mb-1 text-center text-sm text-gray-500">
