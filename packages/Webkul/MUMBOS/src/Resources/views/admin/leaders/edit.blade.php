<x-admin::layouts>
    ...
    <form action="{{ route('admin.leaders.update', $leader) }}" method="POST" enctype="multipart/form-data" class="px-6 space-y-6">
        @csrf
        @method('PUT')
        @include('mumbos::admin.leaders._form', ['leader' => $leader])
    </form>
</x-admin::layouts>
