<x-admin::layouts>
    <div class="flex items-center justify-between mb-4 mt-4">
        <h2 class="text-lg font-semibold">Edit Phase: {{ $phase->name }}</h2>
        ...
        <form method="POST" action="{{ route('admin.phases.update', $phase) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="3"
                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('description', $phase->description) }}</textarea>
