...
<header class="sticky top-0 z-[10001] flex items-center justify-between border-b bg-white px-4 py-2.5 dark:border-gray-800 dark:bg-gray-900">
    <div class="flex items-center gap-1.5">
        ...
        <a href="{{ route('admin.dashboard.index') }}">
            ...
            @else
                <img
                    src="{{ request()->cookie('dark_mode') ? bagisto_asset('images/dark-logo.png') : bagisto_asset('images/logo.png') }}"
                    id="logo-image"
                    alt="{{ config('app.name') }}"
                />
            @endif
...
>
    ...
    <x-slot:header>
        <div class="flex items-center justify-between">
            ...
            @else
                <img
                    src="{{ request()->cookie('dark_mode') ? bagisto_asset('images/logo.png') : bagisto_asset('images/logo.png') }}"
                    id="logo-image"
                    alt="{{ config('app.name') }}"
                />
            @endif
        ...
        app.component('v-dark', {
            ...
            data() {
                return {
                    ...
                    dark_logo: "{{ bagisto_asset('images/dark-logo.png') }}",
                };
            },
