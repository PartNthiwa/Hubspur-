                ...
                <div class="mt-auto">
                    <div class="border-t bg-white py-2 text-center text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-white">
                        @lang('admin::app.components.layouts.powered-by.description', [
                            'THM' => '<a class="text-blue-600 hover:underline dark:text-darkBlue" href="https://thm.com/en/">THM</a>',
                            'TheHubMagharibi' => '<a class="text-blue-600 hover:underline dark:text-darkBlue" href="https://mumbodiaspora.com/">The Hub Magharibi</a>',
                        ])
                    </div>
                </div>
            </div>
