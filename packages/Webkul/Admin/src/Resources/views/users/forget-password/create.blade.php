        ...
        <div class="flex flex-col items-center gap-5">
            ...
            <div class="text-sm font-normal">
                @lang('admin::app.users.forget-password.create.powered-by-description', [
                    'THM' => '<a class="text-blue-600 hover:underline" href="https://thm.com/en/">THM</a>',
                    'TheHubMagharibi' => '<a class="text-blue-600 hover:underline" href="https://mumbodiaspora.org/">The Hub Magharibi</a>',
                ])
            </div>
        </div>
    </div>
